                ...
                <div class="content-wrapper">
                    <section class="content">
                        <div class="update-tourist-div">
                            <!--添加内容-->
                            <form class="form-horizontal" action="${contextPath}/execute/createChannel" method="post">
                                <div class="box-body">
                                        ...
                                        <div class="col-sm-2">
                                            <select class="form-control" id="channelList">
                                                <c:forEach items="${channelList}" var="channel" varStatus="i">
                                                    <option value="${channel.channelName}**${channel.channelFilePath}">${channel.channelName}</option>
                                                </c:forEach>
                                            </select>
                                        </div>
                                    </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-sm-4">
                                            <input type="text" id="channelFilePath" name="channelFilePath" required class="form-control js-title" value="${channelList[0].channelFilePath}" >
                                        </div>
                                    </div>
                                    <div hidden>
