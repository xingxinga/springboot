            ...
            <div class="content-wrapper">
                <section class="content">
                    <div class="update-tourist-div">
                        <!--添加内容-->
                        <form class="form-horizontal" action="${contextPath}/affiliation/create" method="post">
                            <div class="box-body">
                                <!--标题-->
                                <div class="form-group">
                                    <label for="" class="col-sm-2 control-label"><span>*</span>组织名称</label>
                                    <div class="col-sm-4">
                                        <input type="text" class="form-control js-title" id="affiliationName" name="affiliationName"  value="${invoice.invoiceCode}" >
                                    </div>
                                </div>
