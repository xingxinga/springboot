...
(function () {
    ...
    window.UEDITOR_CONFIG = {
        ...
        , toolbars: [[
            ...
            'spechars','print', 'preview','135editor'
        ]]
		...
		,whitList: {
			...
			hr:     [],
			i:      ['class', 'style'],
			img:    ['style','src', 'alt', 'title', 'width', 'height', 'id', '_src',"_url", 'loadingclass', 'class', 'data-latex','vspace'],
			ins:    ['datetime'],
			li:     ['class', 'style'],
			mark:   [],
			nav:    ['class', 'style'],
            ...
            iframe: ['src', 'class', 'height', 'width', 'max-width', 'max-height', 'align', 'frameborder', 'allowfullscreen','style','frameborder']
		}
    };
