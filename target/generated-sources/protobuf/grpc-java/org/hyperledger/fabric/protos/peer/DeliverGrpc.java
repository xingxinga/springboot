...
public final class DeliverGrpc {
  ...
  public static final io.grpc.MethodDescriptor<org.hyperledger.fabric.protos.common.Common.Envelope,
      org.hyperledger.fabric.protos.peer.PeerEvents.DeliverResponse> METHOD_DELIVER = getDeliverMethodHelper();
  ...
  private static io.grpc.MethodDescriptor<org.hyperledger.fabric.protos.common.Common.Envelope,
      org.hyperledger.fabric.protos.peer.PeerEvents.DeliverResponse> getDeliverMethodHelper() {
  ...
  public static final io.grpc.MethodDescriptor<org.hyperledger.fabric.protos.common.Common.Envelope,
      org.hyperledger.fabric.protos.peer.PeerEvents.DeliverResponse> METHOD_DELIVER_FILTERED = getDeliverFilteredMethodHelper();
  ...
  private static io.grpc.MethodDescriptor<org.hyperledger.fabric.protos.common.Common.Envelope,
      org.hyperledger.fabric.protos.peer.PeerEvents.DeliverResponse> getDeliverFilteredMethodHelper() {
  ...
  public static abstract class DeliverImplBase implements io.grpc.BindableService {
    ...
    public io.grpc.stub.StreamObserver<org.hyperledger.fabric.protos.common.Common.Envelope> deliverFiltered(
        io.grpc.stub.StreamObserver<org.hyperledger.fabric.protos.peer.PeerEvents.DeliverResponse> responseObserver) {
      return asyncUnimplementedStreamingCall(getDeliverFilteredMethodHelper(), responseObserver);
    }
  ...
  public static final class DeliverStub extends io.grpc.stub.AbstractStub<DeliverStub> {
    ...
    public io.grpc.stub.StreamObserver<org.hyperledger.fabric.protos.common.Common.Envelope> deliverFiltered(
        io.grpc.stub.StreamObserver<org.hyperledger.fabric.protos.peer.PeerEvents.DeliverResponse> responseObserver) {
      return asyncBidiStreamingCall(
          getChannel().newCall(getDeliverFilteredMethodHelper(), getCallOptions()), responseObserver);
    }
  }
      ...
      synchronized (DeliverGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              ...
              .addMethod(getDeliverFilteredMethodHelper())
              .build();
        }
      }
    }
